...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Daftar Supersub Kategori | <?php include "title.php" ?></title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1>Daftar Supersub Kategori <small><a href="supersubkat_add.php">Tambah Supersub Kategori Baru</a></small></h1>
          <ol class="breadcrumb">
            <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li>Supersub Kategori</li>
            <li class="active"><a href="supersubkat_list.php">Daftar Supersub Kategori</a></li>
          </ol>
        </section>
