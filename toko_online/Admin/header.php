        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            <li class="user-header">
              ...
              <p>
              <?php if ($sesen_usertype == "user" OR "supervisor" OR "admin" OR "superadmin"){echo "$sesen_nama";} ?></p>
              (<?php if($sesen_usertype == 'admin'){echo "Admin";} if($sesen_usertype == 'superadmin'){echo "Super Admin";}?>)
            </li>
            <li class="user-body">
  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      ...
      <div class="pull-left info">
        <p><?php if ($sesen_usertype == "supervisor" OR "admin" OR "superadmin"){echo "$sesen_nama";} ?></p>
        <p>(<?php if($sesen_usertype == 'admin'){echo "Admin ";}if($sesen_usertype == 'superadmin'){echo "Super Admin";}?>)</p>
      </div>
    </div>
